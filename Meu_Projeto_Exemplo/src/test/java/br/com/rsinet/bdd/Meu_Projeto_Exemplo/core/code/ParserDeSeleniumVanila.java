	...
	public static void garantirQueMapasDeObjetosSaoSeleniumVanila(){
		...
		getArquivosDeTodosOsMapasDeObjetos().forEach((f)->{
			try {
				...
				UtilTextFile.substituirCodigo("import br.com.rsinet.bdd.Meu_Projeto_Exemplo.core.annotation.MapaDeObjetos;", "", f);
				UtilTextFile.substituirCodigo("import br.com.rsinet.bdd.Meu_Projeto_Exemplo.core.drive.RSIBDDWebDriver;", "import org.openqa.selenium.support.FindBy;", f);
