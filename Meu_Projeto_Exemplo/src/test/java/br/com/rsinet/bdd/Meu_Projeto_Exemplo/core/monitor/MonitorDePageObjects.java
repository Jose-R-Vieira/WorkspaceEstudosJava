package br.com.rsinet.bdd.Meu_Projeto_Exemplo.core.monitor;
...
import br.com.rsinet.bdd.Meu_Projeto_Exemplo.core.annotation.MapaDeObjetos;
...
import br.com.rsinet.bdd.Meu_Projeto_Exemplo.core.util.UtilFile;
import br.com.rsinet.bdd.Meu_Projeto_Exemplo.core.util.UtilProperties;
import br.com.rsinet.bdd.Meu_Projeto_Exemplo.core.util.UtilString;
...
public class MonitorDePageObjects {
	...
	public void importarCandidatosMapasDeObjetos(){
		...
		getFilesCandidatosMapaDeObjetos().forEach(f ->{
			...
			try{
				...
				//System.out.println("getPathMapaDeObjetos() -> " + UtilProperties.getPathMapaDeObjetos());
	...
	private void anotarObjetoJaMapeado(File f) throws IOException{
		...
		UtilTextFile.substituirCodigo("public class", "import br.com.rsinet.bdd.Meu_Projeto_Exemplo.core.annotation.ObjetoJaMapeado;\n\n@ObjetoJaMapeado\npublic class", f);
	}
	...
	private void implementarInterface(File f) throws IOException{
		//inclui o "implements"
		UtilTextFile.substituirCodigo("public class (.*?) \\{", "import br.com.rsinet.bdd.Meu_Projeto_Exemplo.core.annotation.MapaDeObjetos;\nimport br.com.rsinet.bdd.Meu_Projeto_Exemplo.core.drive.RSIBDDWebDriver;\nimport net.serenitybdd.core.pages.PageObject;\n\npublic class $1 extends PageObject implements MapaDeObjetos {", f);
	...
	public List<MapaDeObjetos> getMapasDeObjetos() throws InstantiationException, IllegalAccessException{
		...
		List<Class<?>> allClasses = new ArrayList(reflections.getSubTypesOf(br.com.rsinet.bdd.Meu_Projeto_Exemplo.core.annotation.MapaDeObjetos.class));		
		System.out.println("passei aqui -> allClasses.size() " + allClasses.size());
