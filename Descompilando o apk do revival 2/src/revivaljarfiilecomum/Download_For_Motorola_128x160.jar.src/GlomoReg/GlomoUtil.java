...
public class GlomoUtil
{
  ...
  {
    return Math.abs(jdField_a_of_type_JavaUtilRandom.nextInt()) % (paramInt2 - paramInt1) + paramInt1;
  }
  ...
  public static final String generateKeyOfType(int paramInt, String paramString, long paramLong)
  {
    ...
    {
      Integer.parseInt(GlomoConfig.distInfo.smsKeyVersion());
      String str2 = (str1 = GlomoConfig.distInfo.channelId()).substring(0, 2);
      String str1 = str1.substring(2, 5);
      paramInt = encryptLight(toBase36((paramLong != 0L ? paramLong : generateRandomKey(0)) * 10000L + Long.parseLong(str1) * 10L + paramInt % 10, 7), 2);
      try
      {
      ...
      return paramString + str2 + paramInt + GlomoConfig.sms_key_version().substring(0, 1);
    }
    paramInt = encryptLight(toBase36((paramLong != 0L ? paramLong : generateRandomKey(0)) * 10000L + Long.parseLong(GlomoConfig.distInfo.id()) * 10L + paramInt % 10, 7), 2);
    try
    {
      i = Long.parseLong(paramInt) == 0L ? 1 : 0;
    }
    ...
    return paramString + paramInt + GlomoConfig.sms_key_version().substring(0, 1);
  }
    ...
    while (i5 > 0)
    {
      ...
      for (int i3 = 4; i3 <= k + 1 << 1; i3 += 2)
      {
        ...
        while (m <= i4)
        {
          ...
          paramInt;
          int i;
          i6 = (m < i4) || ((i3 >> 1) - 2 + (i4 << 1) - i6 - (k >> 1) > 0) ? i2 += (((i3 >> 1) - 2 & n) == 0 ? 1 : -1) * (i1 >> 1) + 2 : (tmp195_185[tmp195_194] = (char)(tmp195_185[tmp195_194] + (paramInt[(i5 - 1 - (i4 << 1) + i6 + (k >> 1))] - (paramInt[(i5 - 1 - (i4 << 1) + i6 + (k >> 1))] = paramInt[(i5 + (i3 >> 1) - 3)])))) + ((i3 >> 1) + (i4 << 1) - (k >> 1) - i6 - 2 == 0 ? '\000' : (paramInt[(i5 + (i3 >> 1) - 3)] = (char)(((i = paramInt[(i5 + (i3 >> 1) - 3)] + '') % 10 + 10 + (i5 - 3) % 10) % 10 + i / 10 * 10 - 142))) + (paramInt[(i5 - 1 - (i4 << 1) + i6 + (k >> 1))] = (char)(((i = paramInt[(i5 - 1 - (i4 << 1) + i6 + (k >> 1))] + '') % 10 + 10 + (i5 - 3) % 10) % 10 + i / 10 * 10 - 142));
          m++;
          n <<= 1;
          i1 >>= 1;
        }
  ...
  public static final String JAD(MIDlet paramMIDlet, String paramString)
  {
    try
    {
      String tmp18_15 = (paramMIDlet.getAppProperty(paramString) == null ? "" : paramMIDlet.getAppProperty(paramString));
      if (tmp18_15.charAt((paramMIDlet = tmp18_15).length() - 1) == ';') {
...
/* Location:              C:\WPrograming\jd-gui-windows-1.4.0\Download_For_Motorola_128x160.jar!\GlomoReg\GlomoUtil.class
