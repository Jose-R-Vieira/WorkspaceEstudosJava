	...
	public static void garantirQueMapasDeObjetosSaoSeleniumVanila(){
		...
		getArquivosDeTodosOsMapasDeObjetos().forEach((f)->{
			try {
				...
				UtilTextFile.substituirCodigo("import br.com.rsinet.bdd.CompraDeProdutos.core.annotation.MapaDeObjetos;", "", f);
				UtilTextFile.substituirCodigo("import br.com.rsinet.bdd.CompraDeProdutos.core.drive.RSIBDDWebDriver;", "import org.openqa.selenium.support.FindBy;", f);
