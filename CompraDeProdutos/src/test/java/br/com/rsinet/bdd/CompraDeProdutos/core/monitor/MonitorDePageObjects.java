package br.com.rsinet.bdd.CompraDeProdutos.core.monitor;
...
import br.com.rsinet.bdd.CompraDeProdutos.core.util.UtilFile;
import br.com.rsinet.bdd.CompraDeProdutos.core.util.UtilProperties;
import br.com.rsinet.bdd.CompraDeProdutos.core.util.UtilString;
import br.com.rsinet.bdd.CompraDeProdutos.core.util.UtilTextFile;
...
public class MonitorDePageObjects {
	...
	private void anotarObjetoJaMapeado(File f) throws IOException{
		...
		UtilTextFile.substituirCodigo("public class", "import br.com.rsinet.bdd.CompraDeProdutos.core.annotation.ObjetoJaMapeado;\n\n@ObjetoJaMapeado\npublic class", f);
	}
	...
	private void implementarInterface(File f) throws IOException{
		//inclui o "implements"
		UtilTextFile.substituirCodigo("public class (.*?) \\{", "import br.com.rsinet.bdd.CompraDeProdutos.core.annotation.MapaDeObjetos;\nimport br.com.rsinet.bdd.CompraDeProdutos.core.drive.RSIBDDWebDriver;\nimport net.serenitybdd.core.pages.PageObject;\n\npublic class $1 extends PageObject implements MapaDeObjetos {", f);
	...
	public List<MapaDeObjetos> getMapasDeObjetos() throws InstantiationException, IllegalAccessException{
		...
		List<Class<?>> allClasses = new ArrayList(reflections.getSubTypesOf(br.com.rsinet.bdd.CompraDeProdutos.core.annotation.MapaDeObjetos.class));		
